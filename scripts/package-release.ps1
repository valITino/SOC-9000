<# 
    ...
    checksums for the setup script and starter zip to allow users to verify integrity.
...
# Compute SHA256 checksums for the setup script and starter zip
...
Append-Checksum "scripts/setup-soc9000.ps1"
