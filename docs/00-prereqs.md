...
The `scripts/host-prepare.ps1` helper uses VMware's `vmnetcfg.exe` to create the required VMnets automatically. After running the script, verify the adapters in **Virtual Network Editor** if needed:
